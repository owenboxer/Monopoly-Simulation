...
public class Property {
	...
	public int rent[] = new int[6], houses = 0, hotels = 0, houseCost; //rent[0]: default rent, rent[n]: n houses, rent[5]: 1 hotel
	...
	public Property(String packedProperty){
		...
		for (int clause = 0; clause < 10; clause++){ // a "clause" is a part of packed data, each of which is separated by a tab
			...
			case 4:
				...
				rent[0] = Integer.parseInt(subString);
				break;
			case 5:
				rent[1] = Integer.parseInt(subString);
				break;
			case 6:
				rent[2] = Integer.parseInt(subString);
				break;
			case 7: 
				rent[3] = Integer.parseInt(subString);
				break;
			case 8:
				if (subString.startsWith("n")) {
					railroad = true;
				...
				rent[4] = Integer.parseInt(subString);
				break;
			case 9:
				rent[5] = Integer.parseInt(subString);
				break;
			}
